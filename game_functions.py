...
def check_events(ai_settings, screen, stats, ship, sb, aliens, bullets, play_button):
	...
	for event in pygame.event.get():
		if event.type == pygame.QUIT:
			...
			check_play_button(ai_settings, screen, stats, ship, sb, aliens, bullets, play_button, mouse_x, mouse_y)
...
def check_play_button(ai_settings, screen, stats, ship, sb, aliens, bullets, play_button, mouse_x, mouse_y):
	"""Start a new game if player clicks Wanna Play?"""
	button_clicked = play_button.rect.collidepoint(mouse_x, mouse_y)
	if button_clicked and not stats.game_active:
		#Reset t game settings
...
def fire_bullet(ai_settings, screen, ship, bullets):
	"""Fire a bullet if limit not rached yet"""
...
def update_screen(ai_settings, screen, stats, ship, sb, aliens, bullets, play_button):
	...
	#Draw the sccore information
	sb.show_score()
	
	#Draw the play button if the game is annactive
	if not stats.game_active:
		play_button.draw_button()
	
	#Make te most recent screen visible
	pygame.display.flip()
...
def update_bullets(ai_settings, screen, stats, ship, sb, aliens, bullets):
	...
	#If so, gt rid of the bullets and aliens
...
def check_bullet_alien_collisions(ai_settings, screen, stats, ship, sb, aliens, bullets):
	...
	#Remove any bullets and aliens that had collided
...
def create_fleet(ai_settings, screen, ship, aliens):
	...
	#Create the alien and find th number of aliens in a row
	...
	for row_number in range(number_rows):
		...
		for alien_number in range(number_aliens_x):
			#Create and place it in the row
...
def ship_hit(ai_settings, stats, screen, ship, sb, aliens, bullets):
	"""Respond to ship being it by an alien"""
...
def update_aliens(ai_settings, stats, screen, ship, sb, aliens, bullets):
	...
	#Look for alies hitting the bottom of the screen
